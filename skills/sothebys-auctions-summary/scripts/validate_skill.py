#!/usr/bin/env python3
"""Minimal relative validator for this skill's frontmatter and required files."""
...
def main() -> None:
    ...
    for rel in ['agents/openai.yaml', 'references/input-contract.md', 'references/output-schema.md', 'references/sothebys-field-notes.md']:
